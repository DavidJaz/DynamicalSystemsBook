...
Bimodules between comonoids correspond to parametric right adjoints between the associated copresheaf categories.
\end{proposition}

This may be hard to parse right now, but we will explain it in \cref{??}. There we'll see that this is where database queries come in.
