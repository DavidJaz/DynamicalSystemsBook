...
\begin{proposition}
The functor $\Cat{Comon}(\poly)\to\poly$ has a right adjoint
\[
\adjr{\poly}{\com{K}_-}{u_-}{\Cat{Comon}(\poly)}
\]
\end{proposition}

\begin{proposition}[Niu, Johnstone-Power-Tsujishita-Watanabe-Worrell]
