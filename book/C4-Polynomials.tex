...
\end{proposition}
\begin{proof}
We will see that $\1$ is a terminal object and that the product of $p$ and q$ in $\poly$ is the usual product of $p$ and $q$ as polynomials. That is, if $p\coloneqq\sum_{i\in p(\1)}\yon^{p_i}$ and $q\coloneqq\sum_{i\in q(\1)}\yon^{q_i}$, then
...
\begin{definition}
Let $p$ and $q$ be polynomials. Their \emph{Dirichlet product} is given by
\end{definition}
