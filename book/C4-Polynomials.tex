...
\mbox{}\hfill --Andr\'e Joyal, personal communication.
\end{quote}
...
We could also call these \emph{generalized Moore machines}, since Moore machines were seen to be given by the special case $p=B\yon^A$ for sets $A,B$. But whether you call these things dependent systems or generalized Moore machines, the question is: what on earth do they do? Let's start with something familiar.
