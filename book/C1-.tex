...
Good introductions to category theory abound. One place to start is \emph{An invitation to applied category theory} \cite{ong2019seven}.
...
\subsection{Lenses and lens composition}
...
\jaz{This is where I left off writing. Nothing after this should be considered ``written''.}
