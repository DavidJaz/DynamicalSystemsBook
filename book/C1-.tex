...
\begin{example}[Multi-city SIR models]
  ...
  \begin{align*}
    ...
    \In{SIR_{City}} &:= \left\{ \begin{bmatrix} a \\ b \\ (e_s, e_i, e_r) \\ (\ell_s, \ell_i, \ell_r) \end{bmatrix}\, \middle|\, a,\,b,\,e,\,\ell \in \Rb \right\}
    \expose{SIR_{City}} &:= \id \\
    \update{SIR_{City}}\left( \begin{bmatrix} s\\ i\\ r \end{bmatrix},\, \begin{bmatrix} a\\ b\\ e\\ \ell\end{bmatrix} \right) &:= \begin{bmatrix}s + \end{bmatrix} 
  \end{align*}
