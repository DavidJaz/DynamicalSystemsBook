...
\begin{itemize}
  ...
  \item The vertical functor is $\Cat{Chart}Arena\left( \lens{I}{O}, - \right) :
    \Cat{Lens} \to \Cat{Matrix}$ from \cref{prop.lens_to_matrix_functor_discrete}.
  \item The horizontal functor is the representable functor $\Cat{Arena}Arena\left(
...
of the composite arise this way. But there is a simple condition we can put on $\Sys{T}$ which will
...
\[
  ...
  \]
  So the two maps are really composable.
