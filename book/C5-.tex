...
\begin{itemize}
	...
	\footnote{\;Note that branches are actually unordered, so it's technically wrong to think of it as a line of green up the right side. Instead, it's just a line of green going up the tree, somewhere.}
...
\begin{enumerate}
	...
	\item What do you think the describable trees have in common, formally?
\qedhere
\end{enumerate}
\end{exercise}
