...
\begin{exercise}\label{exc.linear_composites}
Suppose $A_1,\ldots,A_k$ are sets. What would the notation of \cref{eqn.notation_f1f2fk} look for positions of $A_1\yon\tri A_2\yon\tri\cdots\tri A_k\yon$?
\end{exercise}
