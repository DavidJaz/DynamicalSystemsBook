...
\begin{exercise}
Let $p\coloneqq S\yon^S$. For any $n\in\nn$, write out the morphism of polynomials $\delta^n\colon p\to p\tripow{n+1}$.
\end{exercise}

\begin{example}[Picturing the comonoid $S\yon^S$]
