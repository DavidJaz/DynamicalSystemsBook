...
\footnote{Note that leaving $\circ$ open for use as composition of maps is helping us here.}
\end{exercise}
...
\footnote{We use the symbol $\tri$ here as our monoidal product, to remind the reader that it need not be (and in our case with $\tri$ will not be) symmetric. Moreover, writing $c\tri d$ looks a little like trees growing as you move right.
}
