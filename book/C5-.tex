...
A position $t\in \tr_p\tri\1$ is a called a \emph{tree in $p$.} A direction $n\in\tr_p[t]$ there is called a \emph{node in $t$}.
\end{definition}

Definition \cref{def.cofree} is alluding to a specific image one can form of $\cofree{p}$ in terms of trees. START
