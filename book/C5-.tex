...
\[
\begin{tikzpicture}[trees, bend right, decoration={markings, mark=at position 0.75 with \arrow{stealth}}]
	\foreach \i/\c in {1/red, 2/dgreen, 3/blue}
	{
...
\begin{exercise}
Let $S=\2$ and $c\coloneqq \2\yon^\2$.
\begin{enumerate}
	\item Draw $c$.
	\item Which two maps $ c\to c\tripow{3}$ are supposed to be equal by associativity?
