...
\begin{aligned}
f_1&\in \prod_{i\in p(\1)}q_1(\1),\\
f_2&\in \prod_{i\in p(\1)}\prod_{e_1\in q_{1,f_1(i)}}q_2(\1),\\
f_k&\in \prod_{i\in p(\1)}\prod_{e_1\in q_{1,f_1(i)}}\cdots\prod_{e_{k-1}\in q_{k-1,f_{k-1}(i,d_1,\ldots,d_{k-1})}}q_k(\1),\\
f^\sharp&\in\prod_{i\in p(\1)}\prod_{e_1\in q_{1,f_1(i)}}\cdots\prod_{e_{k-1}\in q_{k-1,f_{k-1}(i,d_1,\ldots,d_{k-1})}}\prod_{e_k\in q_{k,f_k(i,d_1,\ldots,d_k)}}p_i
\end{aligned}
\end{equation}
