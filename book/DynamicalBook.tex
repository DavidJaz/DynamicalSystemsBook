...
\newcommand{\mdot}{{\cdot}}
\newcommand{\cofree}[1]{\com{C}_{#1}}
\newcommand{\coto}{\nrightarrow}
\newcommand{\cofun}{{\raisebox{2pt}{\resizebox{2.5pt}{2.5pt}{$\setminus$}}}}


\newcommand{\bimodto}[1][]{
	\begin{tikzcd}[ampersand replacement=\&]\ar[r, biml-bimr, "#1"]\&~\end{tikzcd}  
}
\newcommand{\bimodfrom}[1][]{
	\begin{tikzcd}[ampersand replacement=\&]\ar[r, bimr-biml, "#1"]\&~\end{tikzcd}  
}
...
\newcommand{\trunc}{\bigtriangledown}
%\newcommand{\trunc}{\dot\bigtriangledown}
 
\newcommand{\tristack}[2]{\def\arraystretch{.8}\begin{array}{c}#1\\\bigtriangledown\\#2\end{array}}
