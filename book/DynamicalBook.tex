...
% amsthm %
  \theoremstyle{plain}
  \newmdtheoremenv[style=theoremframe]{theorem}[subsection]{Theorem}
  \newmdtheoremenv[style=theoremframe]{proposition}[subsection]{Proposition}
  \newmdtheoremenv[style=theoremframe]{corollary}[subsection]{Corollary}
  \newmdtheoremenv[style=theoremframe]{lemma}[subsection]{Lemma}
  
  \theoremstyle{plain}
  \newmdtheoremenv[style=definitionframe]{definition}[subsection]{Definition}
  \newmdtheoremenv[style=definitionframe]{informal}[subsection]{Informal Definition}
  \newmdtheoremenv[style=definitionframe]{semiformal}[subsection]{Semi-formal Definition}
  \newmdtheoremenv[style=definitionframe]{roughDef}[subsection]{Rough Definition}
...
\newmdtheoremenv[style=exampleframe]{example}[subsection]{Example}

\newmdtheoremenv[style=exerciseframe]{exc-inner}[subsection]{Exercise}
