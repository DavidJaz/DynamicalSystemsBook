...
The change of systems theory $\mathcal{E}_{\epsilon}$ is the formula for changing from
...
$\mathcal{E}_{\epsilon}$ gives a change of systems theory on a \emph{restriction} of
...
We have learned about a variety of systems theory through the course of this book:
\begin{itemize}
...
\item There are also the differential systems theories
  ...
  differential systems theories arising from cartesian differential categories and
...
systems theories that we will attend to in this section.

We will begin by defining a \emph{change of systems theory}, which will give us a
category of systems theories.\footnote{\jaz{Actually a 2-category, but this will likely
