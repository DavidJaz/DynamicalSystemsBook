...
We will then show how doubly
indexed categories of systems can be constructed systematically from their
doctrine. In particular, we will show that there is a \emph{2-functor}
...
\subsection{Functoriality of the Vertical Slice Construction}\label{sec.functoriality_vertical_slice}
