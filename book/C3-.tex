...
\begin{definition}
  ...
  $T$, we have a systems theory $\cartdiff$ defined by the indexed category $\smctx{-}
...
\subsection{Dependent deterministic systems theory}
...
The notion of systems thoery, the double category of arenas in a
